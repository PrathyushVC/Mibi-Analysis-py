...
def make_hdf5(dataname,patch_size=32,stride_size=32,mirror_pad_size=16,test_set_size=0.1,resize=1,classes=np.arange(1),data_full_path=None,tables_base_path=None):
